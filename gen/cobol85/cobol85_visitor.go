...
type Cobol85Visitor interface {
	...
	VisitDataDivisionSection(ctx *DataDivisionSectionContext) interface{}
	...
	VisitProcedureDivisionUsingParameter(ctx *ProcedureDivisionUsingParameterContext) interface{}

	// Visit a parse tree produced by Cobol85Parser#procedureDivisionByReferencePhrase.
	VisitProcedureDivisionByReferencePhrase(ctx *ProcedureDivisionByReferencePhraseContext) interface{}

	// Visit a parse tree produced by Cobol85Parser#procedureDivisionByReference.
	VisitProcedureDivisionByReference(ctx *ProcedureDivisionByReferenceContext) interface{}

	// Visit a parse tree produced by Cobol85Parser#procedureDivisionByValuePhrase.
	VisitProcedureDivisionByValuePhrase(ctx *ProcedureDivisionByValuePhraseContext) interface{}

	// Visit a parse tree produced by Cobol85Parser#procedureDivisionByValue.
	VisitProcedureDivisionByValue(ctx *ProcedureDivisionByValueContext) interface{}
	...
	VisitAddToGiving(ctx *AddToGivingContext) interface{}
	...
	VisitDivideInto(ctx *DivideIntoContext) interface{}
	...
	VisitMoveCorrespondingToSendingArea(ctx *MoveCorrespondingToSendingAreaContext) interface{}
