...
func (v *BaseCobol85PreprocessorVisitor) VisitCompilerOptions(ctx *CompilerOptionsContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseCobol85PreprocessorVisitor) VisitCompilerXOpts(ctx *CompilerXOptsContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseCobol85PreprocessorVisitor) VisitCompilerOption(ctx *CompilerOptionContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseCobol85PreprocessorVisitor) VisitCopyLibrary(ctx *CopyLibraryContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseCobol85PreprocessorVisitor) VisitEjectStatement(ctx *EjectStatementContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseCobol85PreprocessorVisitor) VisitSkipStatement(ctx *SkipStatementContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseCobol85PreprocessorVisitor) VisitTitleStatement(ctx *TitleStatementContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseCobol85PreprocessorVisitor) VisitCharDataSql(ctx *CharDataSqlContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseCobol85PreprocessorVisitor) VisitFilename(ctx *FilenameContext) interface{} {
	return v.VisitChildren(ctx)
}
